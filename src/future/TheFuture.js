        ...
        <>
            <div className="detailsCard pageBody">
                ...
                <div className="">
                    ...
                    <div className="marginTop marginBottom2 borderBottom">
                        <div className="bodyText marginBottom ">
                            <p> My mother was fond of telling me, "Tomorrow is a gift, that's why we call it the present,"
                ...
                <div className="resume">
                    <div className="resumeContainer marginTop2">
                        <img id="./resume-blue-1.jpg" className="resumeImage" src={require("./resume-blue-1.jpg")} alt="" />
                        <img id="./resume-blue-2.jpg" className="resumeImage" src={require("./resume-blue-2.jpg")} alt="" />
                    </div>
                </div>
            </div>
        </>
